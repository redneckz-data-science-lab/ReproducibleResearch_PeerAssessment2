...
invisible({
    ...
    storm.data[, EVTYPE := stri_replace_all_regex(EVTYPE, "^FLOOD\\s.*", "FLOOD")]
    storm.data[, EVTYPE := stri_replace_all_regex(EVTYPE, ".*\\sFLOOD$", "FLOOD")]
    storm.data[, EVTYPE := stri_replace_all_regex(EVTYPE, "^HEAT\\s.*", "HEAT")]
    storm.data[, EVTYPE := stri_replace_all_regex(EVTYPE, ".*\\sHEAT$", "HEAT")]
